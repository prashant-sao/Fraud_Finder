    ...
    return (
        <div style={{ minHeight: "100vh", background: "#2ad0c4", display: "flex", alignItems: "center", justifyContent: "center" }}>
            ...
            <form onSubmit={handleSubmit} style={{
                ...
                <h2 style={{ fontFamily: 'JomolhariReg', textAlign: "center", marginBottom: "2.5rem", fontSize: 36, fontWeight: 500 }}>Sign Up</h2>
                <input
                    type="text"
                    name="name"
                    value={form.name}
                ...
                <select
                    ...
                    onChange={handleChange}
                    required
                    style={{ width: "100%", maxWidth: 500, marginBottom: 48, padding: "1rem", borderRadius: 12, border: "1.5px solid #e0e0e0", fontSize: 20, background: "#f9f9f9", color: form.profession ? "#222" : "#aaa", outline: "none" }}
                >
